(() => {
    ...
    (() => {
        ...
        function formFieldsInit(options = {
            ...
            document.body.addEventListener("focusout", (function(e) {
                ...
                if (targetElement.tagName === "INPUT" || targetElement.tagName === "TEXTAREA") {
                    ...
                    if (targetElement.value.trim()) targetElement.parentElement.classList.add("_pending"); else targetElement.parentElement.classList.remove("_pending");
        ...
        let formValidate = {
            ...
            validateInput(formRequiredItem) {
                ...
                if (formRequiredItem.dataset.required === "email") {
                    ...
                    const phoneNumberWithoutSpaces = formRequiredItem.value.replace(/\s/g, "");
        ...
        function initSliders() {
            if (document.querySelector(".progect-slider__body")) new swiper_core_Swiper(".progect-slider__body", {
                ...
                speed: 800,
                pagination: {
                    el: ".content-progect-slider__pagination",
                    type: "fraction"
                },
                navigation: {
                    prevEl: ".progect-slider-arrow--prev",
                    nextEl: ".progect-slider-arrow--next"
                },
                on: {}
            });
        }
